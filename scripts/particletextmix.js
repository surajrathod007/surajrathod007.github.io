...
class Environment {
  constructor(font, particle, container) {
    ...
    this.container = container; // Use the passed container instead of querying #magic
...
window.initParticleText = function(containerId) {
  console.log('Initializing Particle Text Mix with container:', containerId);
